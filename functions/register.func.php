...
function userRegister($nom, $prenom, $email, $motpass,  $Cle, $token)
{
    ...
    global $db;
    $sql = "INSERT INTO users(nom_user, prenom_user, email_user, motpass_user, cle_user, token_user,  created) 
            VALUES(:nom_user, :prenom_user, :email_user, :motpass_user, :cle_user, :token_user, NOW())";
    $req = $db->prepare($sql);
    $c = ([
